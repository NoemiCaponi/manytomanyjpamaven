...
public class UtenteDAOImpl implements UtenteDAO {
	...
	public List<Utente> getEagerRuolo (Ruolo ruoloInput) throws Exception{
		TypedQuery<Utente> query = entityManager
				.createQuery("select u from Utente u left join u.ruoli r where r.id = ?1", Utente.class);
		query.setParameter(1, ruoloInput.getId());
