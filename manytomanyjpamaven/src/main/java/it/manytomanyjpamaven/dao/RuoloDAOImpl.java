...
public class RuoloDAOImpl implements RuoloDAO {
	...
	public void delete(Ruolo ruoloInstance) throws Exception {
		if (ruoloInstance == null) {
			throw new Exception("Valore in input non ammesso");
		}
	...
	@Override
	public Ruolo findByDescrizione(String descrizione) throws Exception {
		if (descrizione == null || descrizione == "") {
			throw new Exception("Valore di input non ammesso");
		}
		TypedQuery<Ruolo> query = entityManager.createQuery("select r from Ruolo r where r.descrizione=?1", Ruolo.class)
